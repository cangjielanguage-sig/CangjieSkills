...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 97 (50.5%) | 165 (85.9%) | 151 (78.6%) |
| 部分命中 PARTIAL | 0 (0.0%) | 16 (8.3%) | 13 (6.8%) |
| 未命中 MISS | 95 (49.5%) | 11 (5.7%) | 28 (14.6%) |
| Recall@5 (FULL+PARTIAL) | 50.5% | 94.3% | 85.4% |
| Precision@1 (FULL) | 50.5% | 85.9% | 78.6% |
| MRR (平均倒数排名) | 0.243 | 0.471 | 0.446 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 159.3ms | 1.6ms | 156.9ms |
| P50 耗时 | 156.1ms | 1.2ms | 155.7ms |
| P95 耗时 | 264.0ms | 4.5ms | 243.6ms |
...
| composition | 60.0% | 100.0% | 93.3% |
| constrained | 40.0% | 75.0% | 70.0% |
| cross_ecosystem | 53.3% | 100.0% | 93.3% |
| enumeration | 45.0% | 100.0% | 95.0% |
| how_to | 50.0% | 95.5% | 86.4% |
| performance_boundary | 43.8% | 100.0% | 87.5% |
| reverse_lookup | 31.2% | 93.8% | 68.8% |
...
| 89 | composition | 做一个带虚拟滚动的大数据表格 | MISS | FULL | MISS |
...
| 164 | performance_boundary | 大量Ability启动性能问题 | MISS | FULL | PARTIAL |
...
| 180 | how_to | UIAbility怎么创建和启动 | MISS | FULL | PARTIAL |
