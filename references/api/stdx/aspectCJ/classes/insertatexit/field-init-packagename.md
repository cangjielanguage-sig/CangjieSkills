<!-- cj-doc kind="api-member" level="6" id="stdx.aspectCJ.class.insertatexit.field-init-packagename" parent="stdx.aspectCJ.class.insertatexit" -->
# InsertAtExit.init(packageName!

[← InsertAtExit](index.md)
