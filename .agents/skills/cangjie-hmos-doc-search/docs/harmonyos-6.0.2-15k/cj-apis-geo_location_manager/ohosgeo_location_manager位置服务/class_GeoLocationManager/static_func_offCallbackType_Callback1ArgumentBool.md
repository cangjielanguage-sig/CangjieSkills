...
|callback|[Callback1Argument](../../../cj-apis-base/.overview.md)\<Bool>|是|-|需要取消订阅的回调函数。该回调函数需要与on接口传入的回调函数保持一致。|
...
GeoLocationManager.off(CallbackType.LocationEnabledChange, testCallbackLocationEnabledChange)
```