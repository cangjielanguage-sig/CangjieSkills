...
- BusinessException：对应错误码的详细介绍参见[Faultlogger错误码](../../cj-errorcode-faultlogger/cj-errorcode-faultlogger.md)和[通用错误码](../../cj-errorcode-universal/cj-errorcode-universal.md)。
