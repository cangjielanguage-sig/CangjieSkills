...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|content|[AppResource](../../../cj-apis-resource_manager/.overview.md)|是|-|TabBar上显示内容。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|icon|[AppResource](../../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** 设置TabBar上显示内容。<br> **说明：** 如果icon采用svg格式图源，则要求svg图源删除其自有宽高属性值。如采用带有自有宽高属性的svg图源，icon大小则是svg本身内置的宽高属性值大小。|
|text|String|是|-| **命名参数。** TabBar上显示的文字内容。|
...
|text|[AppResource](../../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** TabBar上显示的文字内容。|
