...
开发者可以通过调用[startAbility](../../cj-apis-ability/.overview.md)接口，由系统从已安装的应用中寻找符合要求的应用，打开特定文件。
...
开发者通过调用[startAbility](../../cj-apis-ability/.overview.md)接口即可实现由已安装的垂域应用来打开文件。

**表1** startAbility请求中[Want](../../cj-apis-ability/.overview.md)相关参数说明
...
**表3** [flags](../../cj-apis-ability/.overview.md)相关参数说明
