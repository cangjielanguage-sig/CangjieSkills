...
2. 请求权限。
   ...
   (1) 需要申请ohos.permission.DISTRIBUTED_DATASYNC权限，配置方式请参见[声明权限](../../cj-declare-permissions/.overview.md)。

   (2) 同时需要在应用首次启动时弹窗向用户申请授权，使用方式请参见[向用户申请授权](../../cj-request-user-authorization/.overview.md)。
