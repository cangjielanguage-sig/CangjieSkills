...
|**接口**|**说明**|
|:---|:---|
| [shouldBuiltInRecognizerParallelWith](../../../cj-universal-gesture-blocking-enhancement/.overview.md) | 用于设置系统组件内置手势与其他手势并行。 |
| [onGestureRecognizerJudgeBegin](../../../cj-universal-gesture-blocking-enhancement/.overview.md) | 用于手势拦截，获取手势识别器，初始化手势识别器开闭状态。 |
| [parallelGesture](../../../cj-universal-gesture-bind/.overview.md) | 可使开发者定义的手势，与比他优先级高的手势并行。 |
