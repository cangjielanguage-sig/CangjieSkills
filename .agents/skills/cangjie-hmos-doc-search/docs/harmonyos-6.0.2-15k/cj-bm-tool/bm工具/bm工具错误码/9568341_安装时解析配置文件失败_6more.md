...
[module.json、pack.info](../../../application-package-structure-stage/.overview.md)等配置文件格式异常。
...
[module.json、pack.info](../../../application-package-structure-stage/.overview.md)等配置文件存在数据类型错误的字段。
...
[module.json、pack.info](../../../application-package-structure-stage/.overview.md)等配置文件存在字符串长度或者数组大小过大的字段。
