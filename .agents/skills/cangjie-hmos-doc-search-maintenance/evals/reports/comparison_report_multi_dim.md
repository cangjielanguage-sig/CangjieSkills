...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 61 (31.8%) | 143 (74.5%) | 127 (66.1%) |
| 部分命中 PARTIAL | 0 (0.0%) | 28 (14.6%) | 19 (9.9%) |
| 未命中 MISS | 131 (68.2%) | 21 (10.9%) | 46 (24.0%) |
| Recall@5 (FULL+PARTIAL) | 31.8% | 89.1% | 76.0% |
| Precision@1 (FULL) | 31.8% | 74.5% | 66.1% |
| MRR (平均倒数排名) | 0.122 | 0.395 | 0.363 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 38.4ms | 1.3ms | 36.6ms |
| P50 耗时 | 30.3ms | 1.0ms | 30.1ms |
| P95 耗时 | 88.3ms | 3.5ms | 85.1ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 30.0% | 85.0% | 85.0% |
| comparison | 53.3% | 86.7% | 80.0% |
| composition | 46.7% | 86.7% | 86.7% |
| constrained | 25.0% | 75.0% | 70.0% |
| cross_ecosystem | 33.3% | 86.7% | 80.0% |
| enumeration | 25.0% | 95.0% | 85.0% |
| how_to | 22.7% | 86.4% | 54.5% |
| performance_boundary | 37.5% | 100.0% | 81.2% |
| reverse_lookup | 18.8% | 87.5% | 56.2% |
| semantic_fuzzy | 25.0% | 93.8% | 75.0% |
| workflow | 41.2% | 100.0% | 88.2% |
...
|---:|------|------|------|-------|--------|
| 3 | api_lookup | HttpClient怎么创建 | MISS | FULL | FULL |
...
| 48 | reverse_lookup | 要实现页面跳转用什么方法 | MISS | PARTIAL | MISS |
...
| 59 | semantic_fuzzy | 页面切换有白屏怎么办 | MISS | FULL | MISS |
| 60 | semantic_fuzzy | 网络请求报错怎么排查 | MISS | PARTIAL | PARTIAL |
...
| 96 | composition | 做一个带转场的页面跳转 | MISS | FULL | MISS |
...
| 103 | cross_ecosystem | Android的RecyclerView在鸿蒙对应什么 | MISS | PARTIAL | MISS |
...
| 172 | how_to | HTTP请求怎么发 | MISS | PARTIAL | PARTIAL |
...
| 192 | how_to | Environment怎么获取参数 | MISS | FULL | MISS |
