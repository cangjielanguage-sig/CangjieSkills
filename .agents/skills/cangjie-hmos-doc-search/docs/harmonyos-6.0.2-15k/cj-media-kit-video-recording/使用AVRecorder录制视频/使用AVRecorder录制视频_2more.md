...
- 当需要使用相机拍摄时，需要申请**ohos.permission.CAMERA**相机权限。申请方式请参考：[向用户申请授权](../../cj-request-user-authorization/.overview.md)。
- 当需要从图库读取图片或视频文件时，请优先使用媒体库[Picker选择媒体资源](../../cj-photoAccessHelper-photoviewpicker/.overview.md)。
- 当需要保存图片或视频文件至图库时，请优先使用[安全控件保存媒体资源](../../cj-photoAccessHelper-savebutton/cj-photoAccessHelper-savebutton.md)。
