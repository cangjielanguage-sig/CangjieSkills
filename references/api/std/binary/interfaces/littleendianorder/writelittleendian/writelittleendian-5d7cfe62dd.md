<!-- cj-doc kind="api-member" level="7" id="std.binary.interface.littleendianorder.writelittleendian.writelittleendian-5d7cfe62dd" parent="std.binary.interface.littleendianorder.writelittleendian" -->
