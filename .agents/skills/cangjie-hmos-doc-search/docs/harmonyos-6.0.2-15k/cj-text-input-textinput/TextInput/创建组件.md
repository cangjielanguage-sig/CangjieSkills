...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|placeholder|[AppResource](../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** 无输入时的提示文本。|
|text|[AppResource](../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** 输入框当前的文本内容。建议通过onChange事件将状态变量与文本实时绑定，避免组件刷新时TextInput中的文本内容异常。|
