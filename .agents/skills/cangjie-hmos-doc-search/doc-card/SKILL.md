...
本 Skill 仅提供**搜索运行时**，索引构建与评测门禁由 `cangjie-hmos-doc-search-maintenance/card/` 负责。

## 使用入口

```bash
python <CangjieSkills>/.agents/skills/cangjie-hmos-doc-search/doc-card/search_v3.py "我想写一个滑动列表"
python <CangjieSkills>/.agents/skills/cangjie-hmos-doc-search/doc-card/search_v3.py "List" --mode api
python <CangjieSkills>/.agents/skills/cangjie-hmos-doc-search/doc-card/search_v3.py "滚动事件示例" --mode example --json
```
