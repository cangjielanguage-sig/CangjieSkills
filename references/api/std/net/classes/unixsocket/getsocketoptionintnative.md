<!-- cj-doc kind="api-member" level="6" id="std.net.class.unixsocket.getsocketoptionintnative" parent="std.net.class.unixsocket" -->
# UnixSocket.getSocketOptionIntNative
