...
2.自定义组件和它的变量将被删除，如果其有同步的变量，比如[@Link](../../../cj-macro-link/.overview.md)、[@Prop](../../../cj-macro-prop/.overview.md)、[@StorageLink](../../../cj-appstorage/.overview.md)，将从[同步源](../../../cj-state-management-overview/.overview.md)上取消注册。
