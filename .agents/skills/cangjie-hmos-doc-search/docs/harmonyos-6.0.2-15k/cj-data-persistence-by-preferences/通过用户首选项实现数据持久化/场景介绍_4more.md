...
应用首选项的持久化文件保存在应用沙箱内部，可以通过context获取其路径。具体请参见[获取应用文件路径](../../cj-application-context-stage/.overview.md)。
...
以下是用户首选项持久化功能的相关接口，更多接口及使用方式请参见[用户首选项](../../cj-apis-preferences/.overview.md)。
