...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 63 (32.8%) | 182 (94.8%) | 171 (89.1%) |
| 部分命中 PARTIAL | 0 (0.0%) | 4 (2.1%) | 4 (2.1%) |
| 未命中 MISS | 129 (67.2%) | 6 (3.1%) | 17 (8.9%) |
| Recall@5 (FULL+PARTIAL) | 32.8% | 96.9% | 91.1% |
| Precision@1 (FULL) | 32.8% | 94.8% | 89.1% |
| MRR (平均倒数排名) | 0.174 | 0.698 | 0.683 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 21.1ms | 0.5ms | 19.7ms |
| P50 耗时 | 17.9ms | 0.4ms | 16.1ms |
| P95 耗时 | 42.2ms | 1.6ms | 41.2ms |
...
| performance_boundary | 18.8% | 100.0% | 100.0% |
| reverse_lookup | 25.0% | 93.8% | 75.0% |
| semantic_fuzzy | 56.2% | 100.0% | 93.8% |
