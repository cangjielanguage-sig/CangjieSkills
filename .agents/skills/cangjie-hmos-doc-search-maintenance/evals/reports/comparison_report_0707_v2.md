...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 158 (82.3%) | 189 (98.4%) | 182 (94.8%) |
| 部分命中 PARTIAL | 0 (0.0%) | 1 (0.5%) | 0 (0.0%) |
| 未命中 MISS | 34 (17.7%) | 2 (1.0%) | 10 (5.2%) |
| Recall@5 (FULL+PARTIAL) | 82.3% | 99.0% | 94.8% |
| Precision@1 (FULL) | 82.3% | 98.4% | 94.8% |
| MRR (平均倒数排名) | 0.600 | 0.818 | 0.809 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 71.7ms | 0.6ms | 21.4ms |
| P50 耗时 | 74.1ms | 0.4ms | 18.6ms |
| P95 耗时 | 96.1ms | 1.6ms | 42.2ms |
