<!-- cj-doc kind="api-member" level="6" id="std.sort.func.sort.sort-t-array-t-t-t-ordering-bool-bool" parent="std.sort.func.sort" -->
# sort<T>(Array<T>, (T, T) -> Ordering, Bool, Bool)
