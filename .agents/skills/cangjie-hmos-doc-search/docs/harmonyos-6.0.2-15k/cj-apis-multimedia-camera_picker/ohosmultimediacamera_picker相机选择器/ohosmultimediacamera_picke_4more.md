...
|callback|[Callback1Argument](../../cj-apis-base/.overview.md)\<[PickerResult](#struct-pickerresult)>|是|-|使用回调的方式获取相机选择器的处理结果。|
...
**类型：** [CameraPosition](../../cj-apis-multimedia-camera/.overview.md)
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|cameraPosition|[CameraPosition](../../cj-apis-multimedia-camera/.overview.md)|是|-|相机的位置。|
