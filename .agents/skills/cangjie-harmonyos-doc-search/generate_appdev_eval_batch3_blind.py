...
INDEX = ROOT / "index"
BATCH3_OUT = ROOT / "eval_queries_user_appdev_batch3.jsonl"
BLIND_OUT = ROOT / "eval_queries_user_appdev_blind.jsonl"
...
TASK_PATH_OVERRIDES = {
    "ui.interaction.click": [
        "harmonyos-6.1-8k/Guide/arkui-cj/cj-event-overview/cj-event-overview.md",
        "harmonyos-6.1-8k/Guide/arkui-cj/cj-common-events-touch-screen-event/触屏事件/.overview.md",
        "harmonyos-6.1-8k/API/arkui-cj/cj-universal-event-click/.overview.md",
    ],
    "interop.arkts.basic": [
        "harmonyos-6.1-8k/API/arkinterop/cj-apis-ark_interop/.overview.md",
        "harmonyos-6.1-8k/API/arkinterop/cj-apis-ark_interop/ohosark_interopArkTS互操作库/.overview.md",
        "harmonyos-6.1-8k/Guide/learn-cj/FFI/cangjie-arkts/arkts_import_cangjie/.overview.md",
        "harmonyos-6.1-8k/Guide/learn-cj/FFI/cangjie-arkts/cj-using_arkts_module/cj-using_arkts_module.md",
    ],
    "security.aes.basic": [
        "harmonyos-6.1-8k/Guide/security/CryptoArchitectureKit/cj-crypto-aes-sym-encrypt-decrypt-cbc/.overview.md",
        "harmonyos-6.1-8k/Guide/security/CryptoArchitectureKit/cj-crypto-aes-sym-encrypt-decrypt-ccm/.overview.md",
        "harmonyos-6.1-8k/Guide/security/CryptoArchitectureKit/cj-crypto-aes-sym-encrypt-decrypt-gcm/.overview.md",
        "harmonyos-6.1-8k/Guide/security/CryptoArchitectureKit/cj-crypto-sym-encrypt-decrypt-spec/对称密钥加解密算法规格/.overview.md",
    ],
    "ui.dialog.alert": [
        "harmonyos-6.1-8k/API/arkui-cj/cj-dialog-alertdialog/.overview.md",
        "harmonyos-6.1-8k/API/arkui-cj/cj-dialog-alertdialog/警告弹窗AlertDialog/.overview.md",
        "harmonyos-6.1-8k/API/arkui-cj/cj-apis-uicontext-promptaction/PromptAction/class_PromptAction.md",
        "harmonyos-6.1-8k/API/arkui-cj/cj-apis-uicontext-promptaction/PromptAction/class_ShowDialogOptions/.overview.md",
    ],
}
...
DOC_SEEDS = [
    {
        ...
        "acceptable_paths": [
            "harmonyos-6.1-8k/Guide/file-management/cj-share-app-file/.overview.md",
            "harmonyos-6.1-8k/API/CoreFileKit/cj-apis-file_fileuri",
        ],
    },
    {
        ...
        "capability": "media",
        "acceptable_paths": [
            "harmonyos-6.1-8k/API/MediaLibraryKit/cj-apis-file-photo_access_helper",
            "harmonyos-6.1-8k/Guide/media/medialibrary/cj-photoAccessHelper-systemAlbum-guidelines/.overview.md",
        ],
    },
    {
        ...
        "capability": "network",
        "acceptable_paths": [
            "harmonyos-6.1-8k/Guide/network/cj-http-request/HTTP数据请求/证书锁定/.overview.md",
            "harmonyos-6.1-8k/API/NetworkKit/cj-apis-net-http",
        ],
    },
    {
        ...
        "capability": "webview",
        "acceptable_paths": [
            "harmonyos-6.1-8k/API/ArkWeb/cj-apis-webview/ohoswebwebviewWebview/class_WebviewController/func_registerJa_2more_454c827e.md",
            "harmonyos-6.1-8k/API/ArkWeb/cj-apis-webview/.overview.md",
        ],
    },
]
