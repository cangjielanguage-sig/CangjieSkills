<!-- cj-doc kind="api-member" level="6" id="stdx.net.http.class.httprequestbuilder.readtimeout" parent="stdx.net.http.class.httprequestbuilder" -->
# HttpRequestBuilder.readTimeout
