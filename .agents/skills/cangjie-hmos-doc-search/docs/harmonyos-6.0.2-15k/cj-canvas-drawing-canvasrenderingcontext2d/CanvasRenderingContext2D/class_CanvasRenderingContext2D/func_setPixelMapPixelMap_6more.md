...
**功能：** 将当前传入[PixelMap](../../../cj-apis-image/.overview.md)对象绘制在画布上。setPixelMap示例同[getPixelMap](#func-getpixelmapint64-int64-int64-int64)。
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|pixelMap|[PixelMap](../../../cj-apis-image/.overview.md)|是|-|包含像素值的PixelMap对象。<br>初始值：None。|
