...
2. 调用[initSession](../../cj-apis-security_huks/.overview.md)初始化密钥会话，并获取会话的句柄handle。

3. 调用[updateSession](../../cj-apis-security_huks/.overview.md)更新密钥会话。

4. 调用[finishSession](../../cj-apis-security_huks/.overview.md)结束密钥会话，完成派生。
