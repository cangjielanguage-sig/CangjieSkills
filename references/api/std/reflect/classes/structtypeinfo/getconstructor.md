<!-- cj-doc kind="api-member" level="6" id="std.reflect.class.structtypeinfo.getconstructor" parent="std.reflect.class.structtypeinfo" -->
# StructTypeInfo.getConstructor
...
尝试在该 StructTypeInfo 对应的 `struct` 类型中获取与给定形参类型信息列表匹配的 `public` 构造函数的信息。
