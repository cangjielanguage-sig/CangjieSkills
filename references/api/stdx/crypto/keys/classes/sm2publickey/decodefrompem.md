<!-- cj-doc kind="api-member" level="6" id="stdx.crypto.keys.class.sm2publickey.decodefrompem" parent="stdx.crypto.keys.class.sm2publickey" -->
# SM2PublicKey.decodeFromPem
