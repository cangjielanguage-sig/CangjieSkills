...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 71 (37.0%) | 140 (72.9%) | 129 (67.2%) |
| 部分命中 PARTIAL | 0 (0.0%) | 31 (16.1%) | 18 (9.4%) |
| 未命中 MISS | 121 (63.0%) | 21 (10.9%) | 45 (23.4%) |
| Recall@5 (FULL+PARTIAL) | 37.0% | 89.1% | 76.6% |
| Precision@1 (FULL) | 37.0% | 72.9% | 67.2% |
| MRR (平均倒数排名) | 0.132 | 0.384 | 0.351 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 164.9ms | 1.3ms | 164.2ms |
| P50 耗时 | 162.7ms | 1.1ms | 163.8ms |
| P95 耗时 | 274.5ms | 3.9ms | 265.4ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 60.0% | 85.0% | 90.0% |
| comparison | 46.7% | 86.7% | 66.7% |
| composition | 53.3% | 80.0% | 93.3% |
| constrained | 35.0% | 75.0% | 70.0% |
| cross_ecosystem | 33.3% | 86.7% | 73.3% |
| enumeration | 25.0% | 95.0% | 90.0% |
| how_to | 31.8% | 86.4% | 59.1% |
| performance_boundary | 37.5% | 100.0% | 75.0% |
| reverse_lookup | 25.0% | 93.8% | 62.5% |
| semantic_fuzzy | 25.0% | 93.8% | 75.0% |
| workflow | 35.3% | 100.0% | 88.2% |
...
| 12 | api_lookup | SwiperController的API有哪些 | MISS | MISS | MISS |
| 13 | api_lookup | RefreshParams的配置参数 | FULL | MISS | FULL |
...
| 20 | api_lookup | geometryTransition的参数有哪些 | MISS | FULL | PARTIAL |
| 21 | enumeration | Timer定时器的配置参数有哪些 | MISS | FULL | FULL |
| 23 | enumeration | Swiper有哪些回调事件 | MISS | MISS | MISS |
| 24 | enumeration | UIAbility的生命周期状态有哪些 | MISS | FULL | MISS |
| 25 | enumeration | HttpResponse有哪些属性 | MISS | FULL | FULL |
...
| 43 | reverse_lookup | 要实现轮播用什么组件 | MISS | MISS | MISS |
| 44 | reverse_lookup | 要发送通知用什么API | MISS | PARTIAL | MISS |
| 45 | reverse_lookup | 要取消通知用什么方法 | MISS | FULL | MISS |
| 47 | reverse_lookup | 要查询数据库用什么类 | MISS | FULL | MISS |
| 49 | reverse_lookup | 要启动另一个Ability用什么API | MISS | PARTIAL | PARTIAL |
| 50 | reverse_lookup | 要获取相机列表用什么方法 | MISS | FULL | FULL |
| 52 | reverse_lookup | 要设置Cookie用什么API | MISS | PARTIAL | MISS |
| 53 | reverse_lookup | 要实现页面转场用什么API | MISS | FULL | FULL |
| 54 | reverse_lookup | 要实现共享元素转场用什么方法 | MISS | PARTIAL | PARTIAL |
| 55 | reverse_lookup | 要持久化状态用什么组件 | MISS | FULL | FULL |
| 56 | reverse_lookup | 要获取设备环境参数用什么API | MISS | FULL | MISS |
| 57 | semantic_fuzzy | 列表滑动卡顿怎么优化 | MISS | FULL | MISS |
| 58 | semantic_fuzzy | 为什么状态改了界面不更新 | MISS | PARTIAL | PARTIAL |
| 59 | semantic_fuzzy | 页面切换有白屏怎么办 | MISS | PARTIAL | MISS |
...
| 73 | comparison | List和LazyForEach有什么区别 | MISS | FULL | MISS |
...
| 83 | comparison | geometryTransition和sharedTransition | MISS | PARTIAL | PARTIAL |
| 88 | composition | 做一个带下拉刷新的列表页 | FULL | MISS | FULL |
...
| 95 | composition | 做一个带动画的列表删除 | MISS | PARTIAL | PARTIAL |
| 96 | composition | 做一个带转场的页面跳转 | FULL | MISS | FULL |
| 97 | composition | 做一个持久化的用户设置页 | MISS | FULL | PARTIAL |
| 99 | composition | 做一个带相机的页面 | MISS | PARTIAL | PARTIAL |
| 101 | composition | 做一个带通知的下载任务 | MISS | FULL | FULL |
| 103 | cross_ecosystem | Android的RecyclerView在鸿蒙对应什么 | MISS | MISS | MISS |
| 105 | cross_ecosystem | RN的FlatList对应鸿蒙什么组件 | MISS | MISS | MISS |
| 107 | cross_ecosystem | Android的Notification在鸿蒙对应什么 | MISS | PARTIAL | PARTIAL |
| 109 | cross_ecosystem | Android的Camera在鸿蒙对应什么 | MISS | FULL | FULL |
| 110 | cross_ecosystem | iOS的UIView动画在鸿蒙对应什么 | MISS | FULL | FULL |
| 112 | cross_ecosystem | Flutter的Hero动画在鸿蒙对应什么 | MISS | FULL | PARTIAL |
| 113 | cross_ecosystem | Android的SharedPreferences在鸿蒙对应什么 | MISS | FULL | FULL |
| 114 | cross_ecosystem | Android的Activity在鸿蒙对应什么 | MISS | FULL | MISS |
| 115 | cross_ecosystem | Android的Intent在鸿蒙对应什么 | MISS | FULL | FULL |
| 116 | cross_ecosystem | iOS的UIViewController在鸿蒙对应什么 | MISS | FULL | MISS |
...
| 142 | constrained | 动画在弱设备上卡顿怎么办 | MISS | PARTIAL | PARTIAL |
...
| 162 | performance_boundary | 页面转场内存占用过大 | MISS | PARTIAL | MISS |
| 163 | performance_boundary | PersistentStorage读写慢怎么办 | MISS | FULL | FULL |
| 164 | performance_boundary | 大量Ability启动性能问题 | MISS | PARTIAL | MISS |
| 166 | performance_boundary | 相机录像内存飙升怎么办 | MISS | FULL | FULL |
| 169 | performance_boundary | HTTP缓存过多怎么办 | MISS | FULL | FULL |
| 170 | performance_boundary | 定时器执行延迟怎么办 | MISS | FULL | MISS |
| 171 | how_to | List组件怎么用 | MISS | PARTIAL | MISS |
| 175 | how_to | Swiper轮播怎么用 | MISS | MISS | MISS |
| 176 | how_to | Grid网格布局怎么用 | MISS | MISS | MISS |
| 178 | how_to | Timer定时器怎么用 | MISS | FULL | MISS |
| 180 | how_to | UIAbility怎么创建和启动 | MISS | PARTIAL | MISS |
...
| 13 | RefreshParams的配置参数 | FULL | MISS |
...
| 25 | HttpResponse有哪些属性 | MISS | FULL |
