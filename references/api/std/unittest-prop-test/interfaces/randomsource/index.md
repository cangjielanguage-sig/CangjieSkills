<!-- cj-doc kind="api-type" level="5" id="std.unittest.prop_test.interface.randomsource" parent="std.unittest.prop_test" -->
# RandomSource
...
| 扩展声明 | 功能 |
|---|---|
| [`extend Random <: RandomSource`](extensions/extend-random.md) | 对 Random 类型扩展 RandomSource 接口。 |
