...
|weekday|String|否|""| **命名参数。** 工作日的显示格式，取值包括："long", "short", "narrow", "auto"。不同取值的显示效果请参考[时间日期国际化表4](../../../../cj-i18n-time-date/.overview.md)。|
|era|String|否|""| **命名参数。** 时代的显示格式，取值包括："long", "short", "narrow", "auto"。不同取值的显示效果请参考[时间日期国际化表9](../../../../cj-i18n-time-date/.overview.md)。|
|year|String|否|""| **命名参数。** 年份的显示格式，取值包括："numeric", "2-digit"。不同取值的显示效果请参考[时间日期国际化表3](../../../../cj-i18n-time-date/.overview.md)。|
|month|String|否|""| **命名参数。** 月份的显示格式，取值包括："numeric", "2-digit", "long", "short", "narrow", "auto"。不同取值的显示效果请参考[时间日期国际化表6](../../../../cj-i18n-time-date/.overview.md)。|
...
|timeZoneName|String|否|""| **命名参数。** 时区名称的本地化表示，取值包括："long", "short", "auto"。不同取值的显示效果请参考[时间日期国际化表8](../../../../cj-i18n-time-date/.overview.md)。|
|dayPeriod|String|否|""| **命名参数。** 时段的显示格式，取值包括："long", "short", "narrow", "auto"。不同取值的显示效果请参考[时间日期国际化表10](../../../../cj-i18n-time-date/.overview.md)。|
