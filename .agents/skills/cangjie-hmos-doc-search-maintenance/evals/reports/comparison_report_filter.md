...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 71 (37.0%) | 143 (74.5%) | 132 (68.8%) |
| 部分命中 PARTIAL | 0 (0.0%) | 27 (14.1%) | 20 (10.4%) |
| 未命中 MISS | 121 (63.0%) | 22 (11.5%) | 40 (20.8%) |
| Recall@5 (FULL+PARTIAL) | 37.0% | 88.5% | 79.2% |
| Precision@1 (FULL) | 37.0% | 74.5% | 68.8% |
| MRR (平均倒数排名) | 0.147 | 0.383 | 0.356 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 164.8ms | 1.5ms | 163.9ms |
| P50 耗时 | 162.8ms | 1.1ms | 162.1ms |
| P95 耗时 | 275.4ms | 4.1ms | 256.6ms |
