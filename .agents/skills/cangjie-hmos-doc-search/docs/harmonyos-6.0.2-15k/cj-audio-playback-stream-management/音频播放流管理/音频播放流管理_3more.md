...
参考[使用AudioRenderer开发音频播放功能](./cj-using-audiorenderer-for-playback.md)或[createAudioRenderer](../../cj-apis-multimedia-audio/.overview.md)，完成AudioRenderer的创建，然后可以通过以下两种方式查看音频流状态的变化：

- 方法1：直接查看AudioRenderer的[state](../../cj-apis-multimedia-audio/.overview.md)：
...
获取state后可对照[AudioState](../../cj-apis-multimedia-audio/.overview.md)来进行相应的操作，比如更改暂停播放按钮的显示等。
