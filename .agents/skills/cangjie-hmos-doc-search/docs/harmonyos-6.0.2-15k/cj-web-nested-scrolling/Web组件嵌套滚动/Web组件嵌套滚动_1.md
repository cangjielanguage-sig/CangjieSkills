...
内嵌在可滚动容器（[Scroll](../../cj-scroll-swipe-scroll/.overview.md)、[List](../../cj-scroll-swipe-list/.overview.md)中的Web组件，接收到滑动手势事件，需要对接ArkUI框架的[NestedScrollMode](../../cj-common-types/.overview.md)枚举类型，使得Web组件可以嵌套ArkUI可滚动容器，进行嵌套滚动。开发者可以在Web组件创建时，使用[nestedScroll](../../cj-web-web/.overview.md)属性接口指定默认的嵌套滚动模式，也允许在过程中动态改变嵌套滚动的模式。

nestedScroll有两个入参，分别为scrollForward和scrollBackward，均为[NestedScrollMode](../../cj-common-types/.overview.md)枚举类型。
...
> **说明：**
>
> - 支持嵌套滚动的容器：[Grid](../../cj-scroll-swipe-grid/.overview.md)、[List](../../cj-scroll-swipe-list/.overview.md)、[Scroll](../../cj-scroll-swipe-scroll/.overview.md)、[Swiper](../../cj-scroll-swipe-swiper/.overview.md)、[Tabs](../../cj-navigation-switching-tabs/.overview.md)、[WaterFlow](../../cj-scroll-swipe-waterflow/.overview.md)、[Refresh](../../cj-scroll-swipe-refresh/.overview.md)、[bindSheet](../../cj-animation-transition/.overview.md)。
