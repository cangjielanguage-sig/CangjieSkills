...
3. Web组件适配
    ...
    Web组件支持对前端页面进行深色模式配置，可参见[Web组件深色模式](../../../cj-web-set-dark-mode/cj-web-set-dark-mode.md)进行相关配置。
...
4. 应用监听深浅色模式切换事件
    ...
    var currentMode: ConfigurationColorMode = ConfigurationColorMode.COLOR_MODE_LIGHT
    ```
