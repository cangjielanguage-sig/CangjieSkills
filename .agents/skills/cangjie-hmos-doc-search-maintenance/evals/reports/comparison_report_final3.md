...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 71 (37.0%) | 142 (74.0%) | 129 (67.2%) |
| 部分命中 PARTIAL | 0 (0.0%) | 29 (15.1%) | 17 (8.9%) |
| 未命中 MISS | 121 (63.0%) | 21 (10.9%) | 46 (24.0%) |
| Recall@5 (FULL+PARTIAL) | 37.0% | 89.1% | 76.0% |
| Precision@1 (FULL) | 37.0% | 74.0% | 67.2% |
| MRR (平均倒数排名) | 0.132 | 0.388 | 0.354 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 164.2ms | 1.3ms | 164.2ms |
| P50 耗时 | 161.5ms | 1.1ms | 163.7ms |
| P95 耗时 | 266.2ms | 3.5ms | 254.3ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 60.0% | 85.0% | 85.0% |
| comparison | 46.7% | 86.7% | 73.3% |
| composition | 53.3% | 80.0% | 93.3% |
| constrained | 35.0% | 75.0% | 65.0% |
| cross_ecosystem | 33.3% | 86.7% | 73.3% |
| enumeration | 25.0% | 95.0% | 95.0% |
| how_to | 31.8% | 86.4% | 59.1% |
| performance_boundary | 37.5% | 100.0% | 68.8% |
...
| 24 | enumeration | UIAbility的生命周期状态有哪些 | MISS | FULL | PARTIAL |
...
| 44 | reverse_lookup | 要发送通知用什么API | MISS | PARTIAL | PARTIAL |
...
| 69 | semantic_fuzzy | Ability启动失败怎么排查 | MISS | PARTIAL | MISS |
...
| 142 | constrained | 动画在弱设备上卡顿怎么办 | MISS | FULL | MISS |
