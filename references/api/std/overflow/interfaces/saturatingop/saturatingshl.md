<!-- cj-doc kind="api-member" level="6" id="std.overflow.interface.saturatingop.saturatingshl" parent="std.overflow.interface.saturatingop" -->
# SaturatingOp<T>.saturatingShl
