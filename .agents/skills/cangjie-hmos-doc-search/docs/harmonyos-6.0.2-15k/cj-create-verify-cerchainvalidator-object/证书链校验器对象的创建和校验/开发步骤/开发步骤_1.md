...
2. [cert.createCertChainValidator](../../../cj-apis-cert/.overview.md)创建证书链校验器对象。

3. 基于已有的证书数据，创建证书链数据对象[CertChainData](../../../cj-apis-cert/.overview.md)。
...
4. 调用[CertChainValidator.validate](../../../cj-apis-cert/.overview.md)校验证书链数据。
