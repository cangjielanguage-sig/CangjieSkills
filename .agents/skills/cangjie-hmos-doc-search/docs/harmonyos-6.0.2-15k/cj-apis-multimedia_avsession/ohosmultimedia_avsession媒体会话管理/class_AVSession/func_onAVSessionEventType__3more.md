...
|callback|[Callback1Argument](../../../cj-apis-base/.overview.md)\<[LoopMode](#enum-loopmode)>|是|-|入参为[LoopMode](#enum-loopmode)的回调函数，事件与回调的关联详见[AVSessionEventType](#enum-avsessioneventtype)。|
...
|callback|[Callback2Argument](../../../cj-apis-base/.overview.md)\<[ConnectionState](#enum-connectionstate), [OutputDeviceInfo](#class-outputdeviceinfo)>|是|-|入参为[ConnectionState](#enum-connectionstate)和[OutputDeviceInfo](#class-outputdeviceinfo)的回调函数，事件与回调的关联详见[AVSessionEventType](#enum-avsessioneventtype)。|
...
|callback|[Callback2Argument](../../../cj-apis-base/.overview.md)\<String, HashMap\<String, [ValueType](#enum-valuetype)>>|是|-|入参为String和HashMap\<String, [ValueType](#enum-valuetype)>的回调函数，事件与回调的关联详见[AVSessionEventType](#enum-avsessioneventtype)。|
