<!-- cj-doc kind="api-member" level="6" id="std.net.class.unixdatagramsocket.getsocketoptionbool" parent="std.net.class.unixdatagramsocket" -->
# UnixDatagramSocket.getSocketOptionBool
