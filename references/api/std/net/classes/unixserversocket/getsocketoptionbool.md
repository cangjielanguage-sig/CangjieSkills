<!-- cj-doc kind="api-member" level="6" id="std.net.class.unixserversocket.getsocketoptionbool" parent="std.net.class.unixserversocket" -->
# UnixServerSocket.getSocketOptionBool
