...
ret = zip.inflateInit2(ZStream(nextIn: arrayBufferOut, availableIn:UInt32(retStream.totalOut.getOrThrow()),
    nextOut: decompOut, availableOut: UInt32(decompOut.size)), 15)
