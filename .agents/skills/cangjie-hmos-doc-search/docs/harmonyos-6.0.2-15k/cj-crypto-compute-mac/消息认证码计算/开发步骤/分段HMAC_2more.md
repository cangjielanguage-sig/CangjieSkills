...
2. 调用[createSymKeyGenerator](../../../cj-apis-crypto/.overview.md)，生成密钥算法为HMAC的对称密钥（SymKey）。
...
4. 传入自定义消息，将一次传入数据量设置为20字节，多次调用[update](../../../cj-apis-crypto/.overview.md)，进行消息认证码计算。
