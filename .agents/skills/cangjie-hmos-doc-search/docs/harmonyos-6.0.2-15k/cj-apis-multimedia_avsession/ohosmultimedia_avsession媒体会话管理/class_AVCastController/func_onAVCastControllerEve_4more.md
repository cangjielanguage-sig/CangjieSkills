...
|callback|[Callback2Argument](../../../cj-apis-base/.overview.md)\<String, Array\<UInt8>>|是|-|入参为String,Array\<UInt8>>的回调函数，事件与回调的关联详见[AVCastControllerEventType](#enum-avcastcontrollereventtype)。|
