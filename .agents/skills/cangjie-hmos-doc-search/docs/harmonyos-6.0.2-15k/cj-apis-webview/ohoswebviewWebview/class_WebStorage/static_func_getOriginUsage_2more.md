...
|callback|[AsyncCallback](../../../cj-apis-base/.overview.md)\<Int64>|是|-|指定源的存储量。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|callback|[AsyncCallback](../../../cj-apis-base/.overview.md)\<Array\<[WebStorageOrigin](#class-webstorageorigin)>>|是|-|以数组方式返回源的信息，信息内容参考WebStorageOrigin。|
