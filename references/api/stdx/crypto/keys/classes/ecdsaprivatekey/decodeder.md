<!-- cj-doc kind="api-member" level="6" id="stdx.crypto.keys.class.ecdsaprivatekey.decodeder" parent="stdx.crypto.keys.class.ecdsaprivatekey" -->
# ECDSAPrivateKey.decodeDer
