...
首先 [获取收藏夹对象](#获取收藏夹对象)，然后调用 [getAssets](../../../cj-apis-multimedia-photo_accesshelper/.overview.md) 接口获取收藏夹中的资源。
...
4. 调用[getFirstObject](../../../cj-apis-multimedia-photo_accesshelper/.overview.md)接口获取第一张图片。
