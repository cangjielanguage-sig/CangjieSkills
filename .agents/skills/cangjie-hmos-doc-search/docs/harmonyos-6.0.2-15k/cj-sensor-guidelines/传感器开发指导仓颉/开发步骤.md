...
3. 检查是否已经配置相应权限，不同传感器所需权限信息请参见[传感器开发概述](./cj-sensor-overview.md#约束与限制)，具体配置方式请参见[声明权限](../../cj-declare-permissions/.overview.md)，申请权限请参见[向用户申请授权](../../cj-request-user-authorization/.overview.md)。
