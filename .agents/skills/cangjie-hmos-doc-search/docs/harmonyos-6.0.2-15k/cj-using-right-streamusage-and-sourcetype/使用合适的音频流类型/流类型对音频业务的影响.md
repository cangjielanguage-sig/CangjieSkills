...
播放流类型（[StreamUsage](../../cj-apis-multimedia-audio/.overview.md)）决定了音频流所属的音量类型（[AudioVolumeType](../../cj-apis-multimedia-audio/.overview.md)），各类音量类型（如媒体、铃声、闹钟、通话等）拥有独立的音量值，在用户界面上可独立调节，相互之间不会影响。
