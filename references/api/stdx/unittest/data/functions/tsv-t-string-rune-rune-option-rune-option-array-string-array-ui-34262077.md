<!-- cj-doc kind="api-member" level="5" id="stdx.unittest.data.func.tsv-t-string-rune-rune-option-rune-option-array-string-array-ui-34262077" parent="stdx.unittest.data" -->
# tsv<T>(String, Rune, Rune, Option<Rune>, Option<Array<String>>, Array<UInt64>, Array<UInt64>, Bool) where T <: Serializable<T>
...
该函数可从 tsv 文件中读取类型 T 的数据值，其中 T 必须可被序列化。
