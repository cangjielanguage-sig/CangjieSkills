...
- 通过[textAlign](../../../cj-text-input-text/.overview.md)属性设置文本对齐样式。
...
- 通过[textOverflow](../../../cj-text-input-text/.overview.md)属性控制文本超长处理，textOverflow需配合[maxLines](../../../cj-text-input-text/.overview.md)一起使用（默认情况下文本自动折行）。
...
- 通过[lineHeight](../../../cj-text-input-text/.overview.md)属性设置文本行高。
...
- 通过[decoration](../../../cj-text-input-text/.overview.md)属性设置文本装饰线样式及其颜色。
