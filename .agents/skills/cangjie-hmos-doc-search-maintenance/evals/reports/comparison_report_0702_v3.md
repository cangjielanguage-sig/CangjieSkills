...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 117 (60.9%) | 182 (94.8%) | 173 (90.1%) |
| 部分命中 PARTIAL | 0 (0.0%) | 4 (2.1%) | 4 (2.1%) |
| 未命中 MISS | 75 (39.1%) | 6 (3.1%) | 15 (7.8%) |
| Recall@5 (FULL+PARTIAL) | 60.9% | 96.9% | 92.2% |
| Precision@1 (FULL) | 60.9% | 94.8% | 90.1% |
| MRR (平均倒数排名) | 0.200 | 0.697 | 0.684 |
| 平均直接命中数 | 19.1 | 5.0 | 6.0 |
| 平均搜索耗时 | 25.0ms | 0.6ms | 26.1ms |
| P50 耗时 | 23.0ms | 0.4ms | 23.5ms |
| P95 耗时 | 53.4ms | 1.6ms | 56.0ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 60.0% | 95.0% | 85.0% |
| comparison | 73.3% | 93.3% | 93.3% |
| composition | 80.0% | 100.0% | 100.0% |
| constrained | 55.0% | 85.0% | 75.0% |
| cross_ecosystem | 60.0% | 100.0% | 100.0% |
| enumeration | 60.0% | 100.0% | 95.0% |
| how_to | 54.5% | 100.0% | 90.9% |
| performance_boundary | 62.5% | 100.0% | 100.0% |
| reverse_lookup | 43.8% | 93.8% | 81.2% |
| semantic_fuzzy | 75.0% | 100.0% | 100.0% |
...
| 186 | how_to | 图片选择器怎么用 | MISS | FULL | MISS |
