...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 71 (37.0%) | 146 (76.0%) | 133 (69.3%) |
| 部分命中 PARTIAL | 0 (0.0%) | 26 (13.5%) | 19 (9.9%) |
| 未命中 MISS | 121 (63.0%) | 20 (10.4%) | 40 (20.8%) |
| Recall@5 (FULL+PARTIAL) | 37.0% | 89.6% | 79.2% |
| Precision@1 (FULL) | 37.0% | 76.0% | 69.3% |
| MRR (平均倒数排名) | 0.132 | 0.401 | 0.372 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 166.4ms | 1.3ms | 163.7ms |
| P50 耗时 | 163.3ms | 1.0ms | 162.8ms |
| P95 耗时 | 274.8ms | 3.6ms | 261.5ms |
...
| how_to | 31.8% | 86.4% | 68.2% |
| performance_boundary | 37.5% | 100.0% | 87.5% |
| reverse_lookup | 25.0% | 93.8% | 56.2% |
...
| 183 | how_to | 相机拍照怎么实现 | MISS | FULL | PARTIAL |
