...
基于[文件选择器(startAbility)](../cj-file-processing-apps-startup/.overview.md)的分享方式，应用可分享单个文件。被分享应用可通过[ohos.file_fs的open](../cj-apis-file_fs/.overview.md)打开URI，并进行读写操作。
