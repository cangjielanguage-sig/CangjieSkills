...
1. 在module.json5中配置[uris](../../../module-configuration-file/module-configuration-file.md)，步骤如下：
...
2. 解析参数并做对应处理。
    ...
    应用可根据[linkFeature](../../../module-configuration-file/module-configuration-file.md#skills标签)中定义的特性功能，比如路线规划、导航和位置搜索，结合接收到的uri和参数开发不同的样式页面。
