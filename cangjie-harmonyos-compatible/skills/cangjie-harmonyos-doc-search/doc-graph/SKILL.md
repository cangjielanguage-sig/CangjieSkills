...
本 Skill 仅提供**搜索运行时**（cli.py search/neighbors/path/explain/god-nodes/stats 等），图谱构建与评测由 `cangjie-harmonyos-doc-search-maintenance/graph/` 负责。
...
示例：
```
Skill 路径: "C:\CangjieSkills_3499\.agents\skills\cangjie-harmonyos-doc-search"
source_file: "harmonyos-6.0.2-15k/ui/components/List/.overview.md"
→ 完整路径: "C:\CangjieSkills_3499\.agents\skills\cangjie-harmonyos-doc-search\docs\harmonyos-6.0.2-15k\ui\components\List\.overview.md"
```
