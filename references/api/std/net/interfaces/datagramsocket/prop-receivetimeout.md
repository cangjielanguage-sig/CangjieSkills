<!-- cj-doc kind="api-member" level="6" id="std.net.interface.datagramsocket.prop-receivetimeout" parent="std.net.interface.datagramsocket" -->
# DatagramSocket.receiveTimeout
