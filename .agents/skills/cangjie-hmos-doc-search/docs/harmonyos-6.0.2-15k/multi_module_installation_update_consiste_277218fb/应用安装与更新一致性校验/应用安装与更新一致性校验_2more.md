...
>
> 如果使用打包工具进行打包，打包过程中存在合法性校验，具体请参考[打包工具](../../cj-packing-tool/.overview.md)。
...
|appDistributionType|<!--RP1-->应用<!--RP1-->[签名证书](../../cj-apis-bundle_manager/.overview.md)中的app-distribution-type，标识应用的分发类型。<!--RP1End-->|是|更新不同版本时无校验，同版本有校验。|
...
|apl|表示应用程序的[APL等级](../../cj-app-permission-mgmt-overview/.overview.md)，系统定义的apl包括：normal、system_basic和system_core。|是|更新不同版本时无校验，同版本有校验。|