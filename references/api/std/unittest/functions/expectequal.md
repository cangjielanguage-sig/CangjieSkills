<!-- cj-doc kind="api-member" level="5" id="std.unittest.func.expectequal" parent="std.unittest" -->
# expectEqual
...
## expectEqual<T>(String, String, T, T, ?AssertionCtx)
...
## expectEqual<T>(String, String, T, T, Bool, ?AssertionCtx)
