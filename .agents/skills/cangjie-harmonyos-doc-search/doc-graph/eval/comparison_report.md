...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 67 (34.9%) | 179 (93.2%) | 165 (85.9%) |
| 部分命中 PARTIAL | 0 (0.0%) | 7 (3.6%) | 7 (3.6%) |
| 未命中 MISS | 125 (65.1%) | 6 (3.1%) | 20 (10.4%) |
| Recall@5 (FULL+PARTIAL) | 34.9% | 96.9% | 89.6% |
| Precision@1 (FULL) | 34.9% | 93.2% | 85.9% |
| MRR (平均倒数排名) | 0.133 | 0.717 | 0.708 |
| 平均直接命中数 | 5.0 | 5.0 | 5.7 |
| 平均搜索耗时 | 147.3ms | 2.5ms | 149.6ms |
| P50 耗时 | 134.2ms | 1.7ms | 136.1ms |
| P95 耗时 | 315.7ms | 8.2ms | 322.9ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 50.0% | 95.0% | 95.0% |
| comparison | 46.7% | 93.3% | 86.7% |
| composition | 46.7% | 93.3% | 80.0% |
| constrained | 30.0% | 95.0% | 80.0% |
| cross_ecosystem | 33.3% | 100.0% | 100.0% |
| enumeration | 25.0% | 100.0% | 95.0% |
| how_to | 27.3% | 90.9% | 81.8% |
| performance_boundary | 25.0% | 100.0% | 93.8% |
| reverse_lookup | 25.0% | 100.0% | 81.2% |
| semantic_fuzzy | 37.5% | 100.0% | 93.8% |
| workflow | 41.2% | 100.0% | 100.0% |
...
|---:|------|------|------|-------|--------|
| 1 | api_lookup | HttpRequest的timeout参数怎么设置 | MISS | FULL | PARTIAL |
...
| 12 | api_lookup | SwiperController的API有哪些 | MISS | PARTIAL | PARTIAL |
...
| 20 | api_lookup | geometryTransition的参数有哪些 | MISS | PARTIAL | PARTIAL |
| 21 | enumeration | Timer定时器的配置参数有哪些 | MISS | FULL | FULL |
| 22 | enumeration | AppStorage有哪些方法 | MISS | FULL | PARTIAL |
| 23 | enumeration | Swiper有哪些回调事件 | MISS | FULL | MISS |
...
| 43 | reverse_lookup | 要实现轮播用什么组件 | MISS | FULL | MISS |
...
| 54 | reverse_lookup | 要实现共享元素转场用什么方法 | MISS | FULL | FULL |
...
| 69 | semantic_fuzzy | Ability启动失败怎么排查 | MISS | FULL | MISS |
...
| 82 | comparison | animateTo和animation有什么区别 | MISS | FULL | FULL |
...
| 92 | composition | 做一个带图片的通知 | MISS | FULL | MISS |
| 93 | composition | 做一个带进度条的通知 | MISS | FULL | MISS |
...
| 101 | composition | 做一个带通知的下载任务 | MISS | MISS | MISS |
...
| 112 | cross_ecosystem | Flutter的Hero动画在鸿蒙对应什么 | MISS | PARTIAL | PARTIAL |
...
| 140 | constrained | 图片内存占用过大怎么办 | MISS | FULL | MISS |
| 141 | constrained | 相机权限被拒绝怎么办 | MISS | FULL | MISS |
...
| 146 | constrained | 相机权限被拒绝怎么处理 | MISS | PARTIAL | PARTIAL |
| 149 | constrained | 后台任务执行时间过长怎么办 | MISS | FULL | MISS |
...
| 175 | how_to | Swiper轮播怎么用 | MISS | FULL | MISS |
...
| 82 | animateTo和animation有什么区别 | MISS | FULL |
