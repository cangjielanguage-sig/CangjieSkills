...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|src|[AppResource](../../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** 视频的数据源，支持本地视频和网络视频。<br>Resource格式可以跨包/跨模块访问资源文件，常用于访问本地视频。<br>- 支持rawfile文件下的资源，即通过@rawfile引用视频文件。<br>视频支持的格式是：mp4、mkv、TS。|
|currentProgressRate|Float64|否|1.0| **命名参数。** 视频播放倍速。<br>取值仅支持：0.75，1.0，1.25，1.75，2.0。|
|previewUri|[AppResource](../../../cj-apis-resource_manager/.overview.md)|是|-| **命名参数。** 视频未播放时的预览图片路径。|
