...
AppLog.info("getZStream return totalOut: ${retStream.totalOut}")
```
...
|flush|[CompressFlushMode](#enum-compressflushmode)|是|参考[CompressFlushMode定义](#enum-compressflushmode)。|
