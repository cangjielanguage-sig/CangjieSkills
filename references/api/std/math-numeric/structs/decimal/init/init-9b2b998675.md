<!-- cj-doc kind="api-member" level="7" id="std.math.numeric.struct.decimal.init.init-9b2b998675" parent="std.math.numeric.struct.decimal.init" -->
# Decimal.init(Float32)
