...
2. 本地化语言名称。
   ...
   ```cangjie
   let displayLanguage: String = System.getDisplayLanguage('de', 'zh-Hans-CN') // displayLanguage = '德语'
...
3. 本地化国家/地区名称。
   ...
   ```cangjie
   let displayCountry: String = System.getDisplayCountry('SA', 'en-GB') // displayCountry = 'Saudi Arabia'
