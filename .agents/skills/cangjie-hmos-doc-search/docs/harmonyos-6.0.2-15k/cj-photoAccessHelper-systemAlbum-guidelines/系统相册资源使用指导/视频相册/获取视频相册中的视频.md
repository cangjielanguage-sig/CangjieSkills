...
先[获取视频相册对象](#获取视频相册对象)。然后调用[getAssets](../../../cj-apis-multimedia-photo_accesshelper/.overview.md)接口获取视频相册对象中的视频资源。
...
4. 调用[getFirstObject](../../../cj-apis-multimedia-photo_accesshelper/.overview.md)接口获取第一个视频。
