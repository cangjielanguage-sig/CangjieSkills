...
图片解码相关API的详细介绍请参见：[图片解码API说明](../../../cj-apis-image/.overview.md)。
...
2. 获取图片。
    - 方法一：获取沙箱路径。具体请参考[获取应用文件路径](../../../cj-application-context-stage/.overview.md)。应用沙箱的介绍及如何向应用沙箱推送文件，请参考[文件管理](../../../cj-app-sandbox-directory/.overview.md)。
    ...
    - 方法二：通过沙箱路径获取图片的文件描述符。具体请参考[file.fs API参考文档](../../../cj-apis-file_fs/.overview.md)。
    ...
    - 方法三：通过资源管理器获取资源文件的Array\<UInt8>。具体请参考[ResourceManager API参考文档](../../../cj-apis-resource_manager/.overview.md)。
    ...
    - 方法四：通过资源管理器获取资源文件的RawFileDescriptor。具体请参考[ResourceManager API参考文档](../../../cj-apis-resource_manager/.overview.md)。
