...
Web组件提供了[WebCookieManager](../../cj-apis-webview/.overview.md)类，用于管理Web组件的Cookie信息。Cookie信息保存在应用沙箱路径下/proc/{pid}/root/data/storage/el2/base/cache/web/Cookiesd的文件中。

下面以[configCookieSync()](../../cj-apis-webview/.overview.md)接口举例，为“www\.example.com”设置单个Cookie的值“value=test”。其他Cookie的相关功能及使用，请参见[WebCookieManager()](../../cj-apis-webview/.overview.md)API文档。
