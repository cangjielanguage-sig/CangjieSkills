...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 62 (32.3%) | 145 (75.5%) | 126 (65.6%) |
| 部分命中 PARTIAL | 0 (0.0%) | 26 (13.5%) | 22 (11.5%) |
| 未命中 MISS | 130 (67.7%) | 21 (10.9%) | 44 (22.9%) |
| Recall@5 (FULL+PARTIAL) | 32.3% | 89.1% | 77.1% |
| Precision@1 (FULL) | 32.3% | 75.5% | 65.6% |
| MRR (平均倒数排名) | 0.125 | 0.392 | 0.359 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 36.2ms | 1.3ms | 34.1ms |
| P50 耗时 | 27.6ms | 1.0ms | 27.7ms |
| P95 耗时 | 83.6ms | 3.5ms | 82.4ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 40.0% | 85.0% | 80.0% |
| comparison | 46.7% | 86.7% | 73.3% |
| composition | 46.7% | 80.0% | 86.7% |
| constrained | 25.0% | 75.0% | 65.0% |
| cross_ecosystem | 40.0% | 86.7% | 86.7% |
| enumeration | 30.0% | 95.0% | 85.0% |
| how_to | 27.3% | 86.4% | 54.5% |
| performance_boundary | 18.8% | 100.0% | 87.5% |
| reverse_lookup | 18.8% | 93.8% | 62.5% |
| semantic_fuzzy | 25.0% | 93.8% | 87.5% |
...
| 65 | semantic_fuzzy | 动画执行后界面不更新怎么办 | MISS | FULL | PARTIAL |
...
| 96 | composition | 做一个带转场的页面跳转 | MISS | MISS | MISS |
...
| 180 | how_to | UIAbility怎么创建和启动 | MISS | PARTIAL | PARTIAL |
