<!-- cj-doc kind="api-member" level="7" id="std.core.class.box.operator-eq" parent="std.core.class.box.extension.extend-t-box-t-comparable-box-t-where-t-comparable-t" -->
# Box<T>.==
