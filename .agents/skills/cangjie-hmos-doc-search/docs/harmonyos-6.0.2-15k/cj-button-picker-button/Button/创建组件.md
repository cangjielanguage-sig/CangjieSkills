...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|label|[AppResource](../../cj-apis-resource_manager/.overview.md)|是|-|按钮文本内容。当文本字符的长度超过按钮本身的宽度时，文本将会被截断。|
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|label|[AppResource](../../cj-apis-resource_manager/.overview.md)|是|-|设置文本内容。<br>**说明：**<br>当文本字符的长度超过按钮本身的宽度时，文本将会被截断。|
|options|[ButtonOptions](#class-buttonoptions)|是|-|配置按钮的显示样式。|