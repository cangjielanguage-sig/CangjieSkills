<!-- cj-doc kind="api-member" level="6" id="std.fs.struct.fileinfo.setwritable" parent="std.fs.struct.fileinfo" -->
# FileInfo.setWritable
...
对当前实例对应的文件设置文件所有者是否可写入的权限，当前用户没有权限修改则抛出异常。
