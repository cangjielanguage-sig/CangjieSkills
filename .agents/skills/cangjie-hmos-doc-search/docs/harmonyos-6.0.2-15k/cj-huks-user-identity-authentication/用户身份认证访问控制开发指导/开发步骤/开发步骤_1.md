...
1. 生成密钥，指定指纹访问控制类型及相关属性。
   生成或导入密钥时，在密钥属性集中需指定三个参数：用户认证类型[HuksUserAuthType](../../../cj-apis-security_huks/.overview.md)、授权访问类型[HuksAuthAccessType](../../../cj-apis-security_huks/.overview.md)、挑战值类型[HuksChallengeType](../../../cj-apis-security_huks/.overview.md)。
