<!-- cj-doc kind="api-member" level="6" id="stdx.net.http.class.clientbuilder.maxheaderlistsize" parent="stdx.net.http.class.clientbuilder" -->
# ClientBuilder.maxHeaderListSize
