<!-- cj-doc kind="api-member" level="6" id="std.reflect.class.interfacetypeinfo.of" parent="std.reflect.class.interfacetypeinfo" -->
# InterfaceTypeInfo.of
...
- InterfaceTypeInfo - 实例 `a` 的运行时类型所对应的类型信息。
