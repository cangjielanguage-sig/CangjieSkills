<!-- cj-doc kind="api-member" level="6" id="std.collection.concurrent.class.linkedblockingqueue.remove" parent="std.collection.concurrent.class.linkedblockingqueue" -->
# LinkedBlockingQueue<E>.remove
