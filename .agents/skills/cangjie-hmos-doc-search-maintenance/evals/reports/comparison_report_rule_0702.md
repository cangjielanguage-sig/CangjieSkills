...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 26 (13.5%) | 183 (95.3%) | 167 (87.0%) |
| 部分命中 PARTIAL | 0 (0.0%) | 4 (2.1%) | 4 (2.1%) |
| 未命中 MISS | 166 (86.5%) | 5 (2.6%) | 21 (10.9%) |
| Recall@5 (FULL+PARTIAL) | 13.5% | 97.4% | 89.1% |
| Precision@1 (FULL) | 13.5% | 95.3% | 87.0% |
| MRR (平均倒数排名) | 0.102 | 0.695 | 0.675 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 19.3ms | 0.6ms | 18.4ms |
| P50 耗时 | 15.5ms | 0.4ms | 14.7ms |
| P95 耗时 | 40.6ms | 1.6ms | 39.5ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 10.0% | 95.0% | 85.0% |
| comparison | 20.0% | 93.3% | 86.7% |
| composition | 26.7% | 100.0% | 100.0% |
| constrained | 5.0% | 90.0% | 70.0% |
| cross_ecosystem | 6.7% | 100.0% | 93.3% |
| enumeration | 20.0% | 100.0% | 95.0% |
| how_to | 18.2% | 100.0% | 90.9% |
| performance_boundary | 6.2% | 100.0% | 100.0% |
| reverse_lookup | 0.0% | 93.8% | 75.0% |
| semantic_fuzzy | 25.0% | 100.0% | 93.8% |
| workflow | 11.8% | 100.0% | 94.1% |
...
| 46 | reverse_lookup | 要创建数据库用什么API | MISS | FULL | FULL |
...
| 62 | semantic_fuzzy | 数据库查询结果为空怎么办 | MISS | FULL | FULL |
...
| 71 | semantic_fuzzy | WebView加载失败怎么办 | MISS | FULL | FULL |
...
| 78 | comparison | RdbStore和ResultSet有什么区别 | MISS | FULL | MISS |
...
| 90 | composition | WebView调用原生弹窗怎么实现 | MISS | FULL | FULL |
| 91 | composition | 做一个带下拉刷新的网络列表页 | MISS | FULL | FULL |
| 94 | composition | 做一个数据库查询列表 | MISS | FULL | FULL |
...
| 100 | composition | 做一个带WebView的页面 | MISS | FULL | FULL |
| 101 | composition | 做一个带通知的下载任务 | MISS | FULL | FULL |
| 102 | composition | 做一个带数据库的用户管理页 | MISS | FULL | FULL |
...
| 108 | cross_ecosystem | Android的SQLite在鸿蒙对应什么 | MISS | FULL | FULL |
| 109 | cross_ecosystem | Android的Camera在鸿蒙对应什么 | MISS | FULL | MISS |
...
| 117 | cross_ecosystem | React的WebView在鸿蒙对应什么 | MISS | FULL | FULL |
| 119 | workflow | UIAbility启动流程是什么 | MISS | FULL | FULL |
| 120 | workflow | 蓝牙设备连接的完整流程 | MISS | FULL | FULL |
| 121 | workflow | 通知发布的完整流程是什么 | MISS | FULL | FULL |
| 122 | workflow | 数据库操作的完整流程是什么 | MISS | FULL | FULL |
...
| 129 | workflow | 相机初始化流程是什么 | MISS | FULL | MISS |
| 130 | workflow | WebView加载流程是什么 | MISS | FULL | FULL |
| 131 | workflow | BLE扫描结果处理流程 | MISS | FULL | FULL |
...
| 146 | constrained | 相机权限被拒绝怎么处理 | MISS | FULL | MISS |
...
| 152 | constrained | 数据库事务执行时间限制 | MISS | FULL | MISS |
...
| 167 | performance_boundary | BLE连接断开频繁怎么办 | MISS | FULL | FULL |
| 168 | performance_boundary | BLE扫描响应慢怎么办 | MISS | FULL | FULL |
...
| 188 | how_to | 数据库怎么创建 | MISS | FULL | MISS |
...
| 90 | WebView调用原生弹窗怎么实现 | MISS | FULL |
| 91 | 做一个带下拉刷新的网络列表页 | MISS | FULL |
| 94 | 做一个数据库查询列表 | MISS | FULL |
| 98 | 做一个响应深色模式的页面 | MISS | FULL |
| 99 | 做一个带相机的页面 | MISS | FULL |
| 100 | 做一个带WebView的页面 | MISS | FULL |
| 101 | 做一个带通知的下载任务 | MISS | FULL |
| 102 | 做一个带数据库的用户管理页 | MISS | FULL |
...
| 108 | Android的SQLite在鸿蒙对应什么 | MISS | FULL |
...
| 117 | React的WebView在鸿蒙对应什么 | MISS | FULL |
| 119 | UIAbility启动流程是什么 | MISS | FULL |
| 120 | 蓝牙设备连接的完整流程 | MISS | FULL |
| 121 | 通知发布的完整流程是什么 | MISS | FULL |
| 122 | 数据库操作的完整流程是什么 | MISS | FULL |
...
| 130 | WebView加载流程是什么 | MISS | FULL |
| 131 | BLE扫描结果处理流程 | MISS | FULL |
...
| 167 | BLE连接断开频繁怎么办 | MISS | FULL |
| 168 | BLE扫描响应慢怎么办 | MISS | FULL |
