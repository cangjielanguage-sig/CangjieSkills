...
3. 通过调用[getDefaultNet](../../../cj-apis-net-connection/.overview.md)方法，获取默认的数据网络(NetHandle)；或者通过调用[getAllNets](../../../cj-apis-net-connection/.overview.md)方法，获取所有处于连接状态的网络列表(Array\<NetHandle>)。

4. 调用[getNetCapabilities](../../../cj-apis-net-connection/.overview.md)方法，获取NetHandle对应网络的能力信息。能力信息包含了网络类型(蜂窝网络、Wi-Fi网络、以太网网络等)、网络具体能力等网络信息。

5. 调用[getConnectionProperties](../../../cj-apis-net-connection/.overview.md)方法，获取NetHandle对应网络的连接信息。
