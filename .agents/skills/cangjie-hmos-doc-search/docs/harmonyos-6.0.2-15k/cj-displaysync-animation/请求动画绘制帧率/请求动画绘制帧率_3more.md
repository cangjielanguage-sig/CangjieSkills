...
在应用开发中，[属性动画](../../cj-animation-animation/cj-animation-animation.md)和[显式动画](../../cj-animation-animateto/.overview.md)能够使用可选参数[ExpectedFrameRateRange](../../cj-animation-animateto/.overview.md)，为不同的动画配置不同的期望绘制帧率。
