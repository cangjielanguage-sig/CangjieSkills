...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 68 (35.4%) | 157 (81.8%) | 136 (70.8%) |
| 部分命中 PARTIAL | 0 (0.0%) | 18 (9.4%) | 19 (9.9%) |
| 未命中 MISS | 124 (64.6%) | 17 (8.9%) | 37 (19.3%) |
| Recall@5 (FULL+PARTIAL) | 35.4% | 91.1% | 80.7% |
| Precision@1 (FULL) | 35.4% | 81.8% | 70.8% |
| MRR (平均倒数排名) | 0.127 | 0.466 | 0.434 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 119.1ms | 1.7ms | 112.8ms |
| P50 耗时 | 119.7ms | 1.3ms | 113.9ms |
| P95 耗时 | 209.7ms | 4.9ms | 187.4ms |

## 2. 各类别 Recall@5 对比

| 类别 | card | graph | fusion |
|------|------|-------|--------|
| api_lookup | 50.0% | 95.0% | 90.0% |
| comparison | 46.7% | 86.7% | 73.3% |
| composition | 46.7% | 100.0% | 100.0% |
| constrained | 35.0% | 75.0% | 70.0% |
| cross_ecosystem | 33.3% | 93.3% | 93.3% |
| enumeration | 25.0% | 100.0% | 85.0% |
| how_to | 31.8% | 81.8% | 72.7% |
| performance_boundary | 37.5% | 93.8% | 81.2% |
| reverse_lookup | 25.0% | 87.5% | 75.0% |
| semantic_fuzzy | 25.0% | 93.8% | 75.0% |
| workflow | 35.3% | 100.0% | 76.5% |
...
| 58 | semantic_fuzzy | 为什么状态改了界面不更新 | MISS | FULL | MISS |
