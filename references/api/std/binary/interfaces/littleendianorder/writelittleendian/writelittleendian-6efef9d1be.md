<!-- cj-doc kind="api-member" level="7" id="std.binary.interface.littleendianorder.writelittleendian.writelittleendian-6efef9d1be" parent="std.binary.interface.littleendianorder.writelittleendian" -->
