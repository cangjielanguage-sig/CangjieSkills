...
| 接口 | 说明 |
| :-------- | :-------- |
| [linearGradient](../../cj-universal-attribute-gradientcolor/.overview.md) | 为当前组件添加线性渐变的颜色渐变效果。 |
| [sweepGradient](../../cj-universal-attribute-gradientcolor/.overview.md) | 为当前组件添加角度渐变的颜色渐变效果。 |
| [radialGradient](../../cj-universal-attribute-gradientcolor/.overview.md) | 为当前组件添加径向渐变的颜色渐变效果。 |
