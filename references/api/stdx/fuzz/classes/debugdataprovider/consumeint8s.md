<!-- cj-doc kind="api-member" level="6" id="stdx.fuzz.fuzz.class.debugdataprovider.consumeint8s" parent="stdx.fuzz.fuzz.class.debugdataprovider" -->
# DebugDataProvider.consumeInt8s
