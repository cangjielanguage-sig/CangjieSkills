...
|------|------|-------|--------|
| 总查询数 | 192 | 192 | 192 |
| 完全命中 FULL | 63 (32.8%) | 156 (81.2%) | 130 (67.7%) |
| 部分命中 PARTIAL | 0 (0.0%) | 17 (8.9%) | 22 (11.5%) |
| 未命中 MISS | 129 (67.2%) | 19 (9.9%) | 40 (20.8%) |
| Recall@5 (FULL+PARTIAL) | 32.8% | 90.1% | 79.2% |
| Precision@1 (FULL) | 32.8% | 81.2% | 67.7% |
| MRR (平均倒数排名) | 0.125 | 0.462 | 0.428 |
| 平均直接命中数 | 5.0 | 5.0 | 6.0 |
| 平均搜索耗时 | 20.4ms | 1.8ms | 20.9ms |
| P50 耗时 | 16.7ms | 1.3ms | 16.9ms |
| P95 耗时 | 41.2ms | 4.9ms | 47.3ms |
...
| comparison | 46.7% | 80.0% | 73.3% |
| composition | 46.7% | 93.3% | 93.3% |
| constrained | 25.0% | 75.0% | 70.0% |
| cross_ecosystem | 40.0% | 93.3% | 93.3% |
| enumeration | 30.0% | 100.0% | 85.0% |
| how_to | 27.3% | 81.8% | 68.2% |
| performance_boundary | 18.8% | 93.8% | 81.2% |
| reverse_lookup | 18.8% | 87.5% | 62.5% |
