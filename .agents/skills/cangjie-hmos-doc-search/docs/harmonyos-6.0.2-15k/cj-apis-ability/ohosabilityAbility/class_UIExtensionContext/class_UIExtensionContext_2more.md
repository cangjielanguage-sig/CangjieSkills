...
**功能：** UIExtensionContext是[UIExtensionAbility](#class-uiextensionability)的上下文环境，继承自[ExtensionContext](#class-extensioncontext)，提供UIExtensionAbility的相关配置信息以及操作Ability的方法，如启动Ability等。
...
**功能：** 跳出式启动[EmbeddableUIAbility](#class-embeddableuiability)，并通过异步回调返回结果。仅支持在主线程调用
分为以下几种情况：
