...
CangjieSkills 是面向仓颉语言与 HarmonyOS 仓颉应用开发的 Skills 发行包仓库。当前稳定发行标签为 `release-1.0.3`，根目录下按使用场景拆分为 4 个可独立安装的 bundle。
...
npx skills add https://gitcode.com/Cangjie-SIG/CangjieSkills/-/tree/release-1.0.3/cangjie-language-basic -y

# HarmonyOS 仓颉应用开发场景：推荐给普通 HarmonyOS/Cangjie App 开发者
npx skills add https://gitcode.com/Cangjie-SIG/CangjieSkills/-/tree/release-1.0.3/cangjie-harmonyos -y

# HarmonyOS 兼容包开发场景：推荐给普通 HarmonyOS/Cangjie App 开发者
npx skills add https://gitcode.com/Cangjie-SIG/CangjieSkills/-/tree/release-1.0.3/cangjie-harmonyos-compatible -y

# 维护与增强场景：检索索引维护、知识图谱、项目经验沉淀，不建议普通用户默认安装
npx skills add https://gitcode.com/Cangjie-SIG/CangjieSkills/-/tree/release-1.0.3/cangjie-harmonyos-maintenance -y
```
