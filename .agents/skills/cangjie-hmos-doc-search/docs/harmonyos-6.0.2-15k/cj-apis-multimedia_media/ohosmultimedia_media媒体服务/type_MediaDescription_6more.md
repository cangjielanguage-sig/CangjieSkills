...
**功能：** [OnAVPlayerStateChangeHandle](#type-onavplayerstatechangehandle)是[Callback2Argument](../../cj-apis-base/.overview.md)\<[AVPlayerState](#enum-avplayerstate), [StateChangeReason](#enum-statechangereason)>类型的别名。
...
**功能：** [OnBufferingUpdateHandler](#type-onbufferingupdatehandler)是[Callback2Argument](../../cj-apis-base/.overview.md)\<[BufferingInfoType](#enum-bufferinginfotype), Int32>类型的别名。
...
**功能：** [OnTrackChangeHandler](#type-ontrackchangehandler)是[Callback2Argument](../../cj-apis-base/.overview.md)\<Int32, Bool>类型的别名。
...
**功能：** [OnVideoSizeChangeHandler](#type-onvideosizechangehandler)是[Callback2Argument](../../cj-apis-base/.overview.md)\<Int32, Int32>类型的别名。
