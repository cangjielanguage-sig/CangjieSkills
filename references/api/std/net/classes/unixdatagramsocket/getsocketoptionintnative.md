<!-- cj-doc kind="api-member" level="6" id="std.net.class.unixdatagramsocket.getsocketoptionintnative" parent="std.net.class.unixdatagramsocket" -->
# UnixDatagramSocket.getSocketOptionIntNative
