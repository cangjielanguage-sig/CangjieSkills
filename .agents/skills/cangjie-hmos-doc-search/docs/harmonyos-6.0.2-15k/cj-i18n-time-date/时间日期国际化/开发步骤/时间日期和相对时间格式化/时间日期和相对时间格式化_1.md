...
时间日期格式化将表示时间日期的Date对象，通过[DateTimeFormat](../../../../cj-apis-intl/.overview.md)类的[format](../../../../cj-apis-intl/.overview.md)接口实现格式化，具体开发步骤如下。
...
以时间：2021年9月17日 13:04:00、2021年9月17日 00:25:00，locale: zh-CN和en为例，说明[DateTimeOptions](../../../../cj-apis-intl/.overview.md)不同的取值和显示结果。
