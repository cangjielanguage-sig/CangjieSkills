...
1. 应用侧代码中，Web组件配置[onPermissionRequest](../../../cj-web-web/.overview.md)接口，可通过[PermissionRequest](../../../cj-web-web/.overview.md)的[getAccessibleResource](../../../cj-web-web/.overview.md)接口获取请求权限的资源类型，当资源类型为TYPE_SENSOR时，进行传感器授权处理。
