<!-- cj-doc kind="api-member" level="6" id="std.net.class.tcpserversocket.getsocketoptionintnative" parent="std.net.class.tcpserversocket" -->
# TcpServerSocket.getSocketOptionIntNative
