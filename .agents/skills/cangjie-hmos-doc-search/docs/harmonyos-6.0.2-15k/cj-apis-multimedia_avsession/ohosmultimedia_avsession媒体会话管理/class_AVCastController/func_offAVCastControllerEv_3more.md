...
|callback|?[Callback1Argument](../../../cj-apis-base/.overview.md)\<Array\<[AVCastControlCommandType](#enum-avcastcontrolcommandtype)>>|否|None| **命名参数。** 已注册的回调函数，未填则取消该事件下所有已注册的回调函数。|
...
|callback|?[Callback1Argument](../../../cj-apis-base/.overview.md)\<[BusinessException](../../../cj-apis-base/.overview.md)>|否|None| **命名参数。** 已注册的回调函数，未填则取消该事件下所有已注册的回调函数。|
...
|callback|?[Callback2Argument](../../../cj-apis-base/.overview.md)\<String, Array\<UInt8>>|否|None| **命名参数。** 已注册的回调函数，未填则取消该事件下所有已注册的回调函数。|
