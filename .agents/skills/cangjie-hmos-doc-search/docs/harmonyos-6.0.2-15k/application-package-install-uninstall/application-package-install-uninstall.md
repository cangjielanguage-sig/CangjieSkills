...
开发者可以通过调试命令安装和卸载应用，安装应用命令参考bm工具中的[install](../cj-bm-tool/.overview.md)，卸载应用命令参考bm工具中的[uninstall](../cj-bm-tool/.overview.md)，详情参考[编译发布与上架部署流程图](./application-package-structure-stage.md#发布态包结构)。
