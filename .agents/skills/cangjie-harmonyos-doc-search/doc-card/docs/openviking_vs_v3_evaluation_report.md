...
| 工具 | 路径 | 功能 |
|------|------|------|
| `ab_test_openviking_vs_v3.py` | maintenance/scripts/ | AB 评测主脚本 |
| `run_multidim_ab_test.py` | maintenance/scripts/ | 多维评测合并脚本 |
| `eval_bench.py` | maintenance/scripts/ | 基础评测执行引擎 |
| `run_release_eval.py` | maintenance/scripts/ | 发布评测流水线 |
| `validate_eval_set.py` | maintenance/scripts/ | 评测集健康度校验 |
| `sample_eval.py` | maintenance/scripts/ | 分层抽样工具 |
| `analyze_user_eval_failures.py` | maintenance/scripts/ | 失败分析工具 |
