...
2. 调用接口[getKeyItemProperties](../cj-apis-security_huks/.overview.md)，传入参数keyAlias和options。options为预留参数，当前可传入空。

3. 返回值为[HuksReturnResult](../cj-apis-security_huks/.overview.md)类型对象，获取的属性集在properties字段中。
