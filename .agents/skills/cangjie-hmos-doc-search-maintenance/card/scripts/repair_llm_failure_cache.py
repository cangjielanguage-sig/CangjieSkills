#!/usr/bin/env python3
"""为 cangjie-hmos-doc-search 的 LLM failure 生成本地 fallback 缓存。
...
DOC_SEARCH = SKILLS_DIR / "cangjie-hmos-doc-search"
DOC_CARD = DOC_SEARCH / "doc-card"
DOCS_DIR = DOC_SEARCH / "docs"
BUILDER_DIR = SKILLS_DIR / "cangjie-hmos-doc-search-maintenance" / "builder"
