...
格式化相对时间将表示时间日期的Date对象，通过[RelativeTimeFormat](../../../cj-apis-intl/.overview.md)类的[format](../../../cj-apis-intl/.overview.md)接口实现格式化，具体开发步骤如下。
...
以相对时间：一天前，locale: fr-FR和en-GB为例，说明[RelativeTimeFormatInputOptions](../../../cj-apis-intl/.overview.md)不同的取值和显示结果。
